#  хранит базовый URL веб-сервиса, который используется для доступа к API или другим ресурсам.
...
URL_SERVICE = "https://a4e2f248-693a-476d-a240-5196696d9fa0.serverhub.praktikum-services.ru"
